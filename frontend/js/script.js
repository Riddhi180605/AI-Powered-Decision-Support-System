...
function getAPIUrl() {
    ...
    // Default to same-origin when deployed behind one domain.
...
async function uploadFile(file) {
    ...
    try {
        ...
        showError('Error connecting to server. Make sure the backend is running and reachable from this page origin.');
        document.getElementById('loading').style.display = 'none';
        document.getElementById('fileInfo').style.display = 'block';
    }
}
